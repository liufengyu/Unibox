...
-(void)setup
{
    ...
    if(!_controlView)
    {
        ...
        if(nibArray.count > 0)
        {
            ...
            NSDictionary *paramDic = @{@"viewHeight":@(40.0f)};
...
- (void)prepareToPlayAsset:(AVURLAsset *)asset withKeys:(NSArray *)requestedKeys
{
    ...
    if(!_videoView)
    {
        self.videoView = [[ZXVideoView alloc]initWithFrame:self.bounds];
        ...
        [self insertSubview:_videoView belowSubview:_controlView];
